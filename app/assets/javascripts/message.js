$(function(){
 ...
 if(message.image){
  var  html = `<p><img src= ${message.image} class="chat-content__message" width="300" height="200"></p>`
 }else{ var html = " "}

  var htmls = `<p class="chat-content__users">${message.user_name}
  <span class="chat-content__time"> ${message.created_at}</span></p>
  <p class="chat-content__message"> ${message.body}</p> ${html}`
  return htmls;
 }
